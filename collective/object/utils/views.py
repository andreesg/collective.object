        ...
        for field, choice in identification_tab:
            ...
            # Taxonomy special case
                ...
                if len(taxonomy) > 0:
                    ...
                    #    object_schema[field_schema]['fields'].append({"title": self.context.translate(_('Scient. name')), "value": scientific_name})
                    #if common_name != "" and common_name != " ":
                    #    object_schema[field_schema]['fields'].append({"title": self.context.translate(_('Common name')), "value": common_name})
